...
WavePCM.prototype.getFileFromBuffers = function (buffers) {
	// not working for single file buffers
	return this.getFile(this.mergeBuffers(buffers))
};
...
WavePCM.prototype.requestData = function () {
	return this.getFileFromBuffers(this.recordedBuffers);
};
